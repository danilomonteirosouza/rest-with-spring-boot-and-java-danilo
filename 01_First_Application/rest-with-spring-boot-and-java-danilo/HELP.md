...
* The original package name 'com.awaken.rest-with-spring-boot-and-java-danilo' is invalid and this project uses 'com.awaken.rest_with_spring_boot_and_java_danilo' instead.
